...
function sendDisplayDataToSimulator(dataPtr,x1,y1,width,height) { var length = width * height * 4; var buffer = new Uint8ClampedArray(HEAPU8.buffer.slice(dataPtr), 0, length); var context = document.querySelector("#osNanoDisplay").getContext("2d"); var imageData = new ImageData(buffer, width, height); context.putImageData(imageData, x1, y1); requestAnimationFrame(function() { Module.display_render(); }); }
...
var wasmImports = {
  ...
  sendDisplayDataToSimulator: sendDisplayDataToSimulator,
  strftime: _strftime,
  strptime: _strptime
};
var asm = createWasm();
...
var ___emscripten_embedded_file_data = Module['___emscripten_embedded_file_data'] = 178908;
var ___start_em_js = Module['___start_em_js'] = 197804;
var ___stop_em_js = Module['___stop_em_js'] = 198231;
